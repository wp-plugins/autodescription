...
function hmpl_ad_constants() {
	if ( !defined( 'HMPL_AD_SEO_SETTINGS_FIELD' ) )
        define( 'HMPL_AD_SEO_SETTINGS_FIELD', apply_filters( 'hmpl_ad_settings_field', 'hmpl-ad-seo-settings' ) );
	if ( !defined( 'HMPL_AD_VERSION' ) )
        define( 'HMPL_AD_VERSION', '2.1.4' );
}
...
function hmpl_auto_description_run() {
	...
	if ($load !== false) {
		...
		// Deprecated filter
		$deprecated = apply_filters( 'hmpl_ad_load_logged_out_only', $deprecated = '' );
		if ( !empty( $deprecated ) )
			_deprecated_function( 'hmpl_ad_load_logged_out_only', '2.1.5', '' );
